...
LR = 1e-3  # 2e-3  # 0.0014462413062537917  # 2e-3
NUM_EPOCHS = 1000
OVERFIT = False
...
EVAL_USE_FINAL_POSITIONS_SUPERVISED = False
EVAL_USE_FINAL_POSITIONS_UNSUPERVISED = False

EVAL_BATCH_SIZE = 1 if PLOT_MODE else 32 * 8
