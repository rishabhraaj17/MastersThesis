...
if __name__ == '__main__':
    ...
    if not eval_mode and EXECUTE_STEP == STEP.UNSUPERVISED:
        ...
        custom_video_dict = {
            ...
            'video_path': f'../Datasets/Oxford/input_video_s2_l1_01.mp4',
            'start': 0,
            'end': 20,
            'pts_unit': 'sec'
        }
        ...
        if custom_video_mode:
            ...
            video_save_path = f'../Plots/baseline_v2/v{version}/custom/{video_class}/zero_shot/'
            Path(video_save_path).mkdir(parents=True, exist_ok=True)

            features_save_path = f'../Plots/baseline_v2/v{version}/custom/{video_class}/zero_shot/'
            Path(features_save_path).mkdir(parents=True, exist_ok=True)
        else:
